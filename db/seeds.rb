...
#leiya items
w_flannel_1 = leiya.items.create(name: "Black Stewart Tartan", description: "Scotch Plaid Flannel Shirt, Relaxed", price: 24, image: @images["red_flannel"] , inventory: 32)
